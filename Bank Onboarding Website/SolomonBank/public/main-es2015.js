            ...
            this._AuthService
                ...
                setTimeout(() => {
                    if (resp) {
                        ...
                        this.countDown = rxjs_Observable__WEBPACK_IMPORTED_MODULE_9__["Observable"].timer(0, 10000)
                            .take(this.counter)
                            .map(() => {
                            this.appLoader.hideLoader();
                            if (this.counter === 1) {
...
let AccountSummaryComponent = class AccountSummaryComponent {
    constructor(loaderservice, fb, appservice, 
    ...
    deactivateAccount() {
        const ssnUserData = this.appservice.getSsnData();
...
let appService = class appService {
    ...
    setHasAccount(booleanData) {
        this.hasAccount = booleanData;
    }
    setHasBiometricDone(booleanData) {
...
let AuthService = class AuthService {
    ...
    depositSuccessful(data) {
        return this.http.post(this.paymentSuccURL, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(result => {
            // localStorage.setItem('access_token', result.token);
            return result;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('otp', data)));
    }
...
let DepositMoneyComponent = class DepositMoneyComponent {
    constructor(fb, progressService, _appservice, mobService, 
    //private platware: PlatwareService,
    //private appservice: appService,
...
let MobileComponent = class MobileComponent {
    ...
    constructor(loaderservice, fb, _authService, appservice, 
    //private platware: PlatwareService,
        ...
        this._authService
            ...
            if (resp) {
                if (resp.data.biometricDone == true) {
                    this.appservice.setHasBiometricDone(true);
                }
                if (resp.data.accountDetails && resp.data.accountDetails.accountNumber) {
                    ...
                    this.dialogueservice.confirmBox({
                        ...
                        console.log(res);
                        this.appservice.setSsnData(resp.data);
                        this.appservice.setHasAccount(true);
